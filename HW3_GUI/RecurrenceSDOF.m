function [u,v,a,Sd,Sv,Sa,PSv,PSa] = RecurrenceSDOF(Tn,E,A,dt,u0,v0)
%% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RECURRENCE SDOF
...
% 
% OUTPUTS:
% u - relative displacement time history [in]
...
% subplot(4,1,2); plot(t,u,'r'); grid on; xlabel('Time [s]'); ylabel('Displacement [in]'); title('Displacement Time History');xlim([0 dt*n]);
% subplot(4,1,3); plot(t,v,'m'); grid on; xlabel('Time [s]'); ylabel('Velocity [in/s]'); title('Velocity Time History'); xlim([0 dt*n]);
